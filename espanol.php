...
// raw date is in format YYYYDDMM, or MMDDYYYY
...
define('TEXT_DISPLAY_NUMBER_OF_PRODUCTS_NEW', 'Viendo del  <strong>%d</strong> al <strong>%d</strong> (de <strong>%d</strong> nuevos productos)');
define('TEXT_DISPLAY_NUMBER_OF_SPECIALS', 'Viendo del <strong>%d</strong> al <strong>%d</strong> (de <strong>%d</strong> especiales)');
...
define('TEXT_GREETING_PERSONAL', 'Bienvenido de vuelta <span class="greetUser">%s!</span> Would you like to see which <a href="%s"><u>new products</u></a> are available to purchase?');
define('TEXT_GREETING_PERSONAL_RELOGON', '<small>If you are not %s, please <a href="%s"><u>log yourself in</u></a> with your account information.</small>');
define('TEXT_GREETING_GUEST', 'Bienvenido <span class="greetUser">Invitado!</span> Le gustaría <a href="%s"><u>ingresar su cuenta</u></a>? o preferiria <a href="%s"><u>crear nueva cuenta</u></a>?');
...
// reviews
define('REVIEWS_TEXT_RATED', 'Comentado %s por <cite title="%s" itemprop="author">%s</cite>');
define('REVIEWS_TEXT_AVERAGE', 'Valoración media basada en <span itemprop="ratingCount">%s</span> comentarios(s) %s');
